...
bool melee_attack::handle_phase_dodged()
{
        ...
        && !mons_aligned(attacker, defender)) // confused friendlies attacking
    {
        ...
        // Ratling redirection works on every attack in a round.
        if (defender->is_player() && you.species == SP_RATLING)
        {
            do_ratling_redirection();
...
void melee_attack::do_ratling_redirection()
{
